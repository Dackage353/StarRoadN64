...
enum LayerBatches {
    ...
    LAYER_ALPHA_COINS_FIRST = LAYER_ALPHA_BATCHES_BASE,
    LAYER_ALPHA_COINS_LAST = LAYER_ALPHA_COINS_FIRST + 4,
    LAYER_ALPHA_SMOKE,
    LAYER_ALPHA_BATCHES_COUNT,

    LAYER_TRANSPARENT_BATCHES_BASE = 0,
    LAYER_TRANSPARENT_SMOKE = LAYER_TRANSPARENT_BATCHES_BASE,
    LAYER_TRANSPARENT_MIST,
    LAYER_TRANSPARENT_RED_FLAMES_FIRST,
    LAYER_TRANSPARENT_RED_FLAMES_LAST = LAYER_TRANSPARENT_RED_FLAMES_FIRST + 7,
    LAYER_TRANSPARENT_BLUE_FLAMES_FIRST,
    LAYER_TRANSPARENT_BLUE_FLAMES_LAST = LAYER_TRANSPARENT_BLUE_FLAMES_FIRST + 7,
    LAYER_TRANSPARENT_BATCHES_COUNT,

    LAYER_TRANSPARENT_DECAL_BATCHES_BASE = 0,
    LAYER_TRANSPARENT_DECAL_SHADOW_CIRCLE = LAYER_TRANSPARENT_DECAL_BATCHES_BASE,
    LAYER_TRANSPARENT_DECAL_BATCHES_COUNT,

    LAYER_CLD_BATCHES_BASE = 0,
    LAYER_CLD_SHADOW_CIRCLE = LAYER_CLD_BATCHES_BASE,
    LAYER_CLD_BATCHES_COUNT,
};
