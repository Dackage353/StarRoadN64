...
static s32 bhv_cmd_randomize_object(void) {
    ...
    if (gCurrentObject->behavior == bhvMessagePanel
     || gCurrentObject->behavior == bhvBobombBuddy
     || gCurrentObject->behavior == bhvStarRoadYoshi
     || gCurrentObject->behavior == bhvStarRoadHPYoshi
     || gCurrentObject->behavior == bhvStarRoadGGBoo
     || gCurrentObject->behavior == bhvStarRoadPeach
     || gCurrentObject->behavior == bhvStarRoadLLFMips) {
