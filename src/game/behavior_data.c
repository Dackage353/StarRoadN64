...
const BehaviorScript bhvMrI[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_MOVE_XZ_USING_FVEL | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    RANDOMIZE_OBJ(RAND_TYPE_GROUNDED | RAND_TYPE_SPAWN_FAR_FROM_WALLS | RAND_TYPE_LIMITED_BBH_HMC_SPAWNS | RAND_TYPE_HAS_SAFE_GROUND_AROUND),
    SET_HOME(),
...
extern void bhv_pole_star_road_wc_pole_init(void);
const BehaviorScript bhvStarRoadWCPole[] = {
    BEGIN(OBJ_LIST_POLELIKE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INT(oInteractType, INTERACT_POLE),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 1500),
    CALL_NATIVE(bhv_pole_star_road_wc_pole_init),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvThwompNonRandomized[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(thwomp_seg5_collision_0500B7D0),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    DROP_TO_FLOOR(),
...
extern void bhv_ukiki_cage_star_init();
...
const BehaviorScript bhvStarRoadBOIPlatform[] = {
    ...
    CALL_NATIVE( bhv_ssl_moving_pyramid_wall_init),
    RANDOMIZE_OBJ(RAND_TYPE_SAFE | RAND_TYPE_CREATE_AVOIDANCE_POINT),
...
const BehaviorScript bhvStarRoadGGBigRotatingPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags,1),
    SCALE(0,32),
    CALL_NATIVE( bhv_rotating_octagonal_plat_init),
...
static const BehaviorScript Bhv_Custom_0x13003b70[] = {
...
extern const Collision col_rr_geo_0008C0_0xfab809[];
const BehaviorScript bhvStarRoadGGSquarePlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags,1),
...
extern const Collision col_rr_geo_000678_0xfb0201[];
const BehaviorScript bhvStarRoadGGTwistyPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
...
extern const Collision col_rr_geo_000690_0xfb1dc9[];
const BehaviorScript bhvStarRoadGGGrave[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags,1),
    RANDOMIZE_OBJ(RAND_TYPE_GROUNDED | RAND_TYPE_CREATE_AVOIDANCE_POINT),
...
extern const Collision col_rr_geo_0006A8_0xfb6a89[];
const BehaviorScript bhvStarRoadGGLamp[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags,1),
...
extern const Collision col_rr_geo_0006C0_0xfa9149[];
const BehaviorScript bhvStarRoadGGDonutPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags,9),
...
const BehaviorScript bhvStarRoadGGBoo[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
