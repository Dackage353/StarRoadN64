...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(1, castle_courtyard_area_1),
		...
		OBJECT_WITH_ACTS(34,-3141,1512,-1246,0,90,0,0x0 + RANDO_DOOR_PARAM(Randomizer_STAR_REQ_BASE), bhvDoor,31),
		OBJECT_WITH_ACTS(36,1162,1512,-1244,0,270,0,0x1e1e0000 + RANDO_DOOR_PARAM(Randomizer_STAR_REQ_MMM), bhvDoor,31),
		OBJECT_WITH_ACTS(36,2886,-3385,-2107,0,0,0,0x1e1e0000 + RANDO_DOOR_PARAM(Randomizer_STAR_REQ_KC), bhvDoor,31),
		...
		OBJECT_WITH_ACTS(0,-1833,-3373,-1246,0,180,0,0x28000000 + RANDO_DOOR_PARAM(Randomizer_STAR_REQ_B2), bhvStarDoor,31),
		OBJECT_WITH_ACTS(0,-1991,-3373,-1214,0,0,0,0x28000000 + RANDO_DOOR_PARAM(Randomizer_STAR_REQ_B2), bhvStarDoor,31),
