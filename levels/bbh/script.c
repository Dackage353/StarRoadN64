...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT_WITH_ACTS(56,4385,2330,-3141,0,0,0,0x1010000, bhvSlidingPlatform2,1),
		...
		OBJECT_WITH_ACTS(56,1920,-573,1952,0,0,0,0x10000, bhvSlidingPlatform2,23),
		...
		OBJECT_WITH_ACTS(54,-1160,1666,-4984,0,0,0,0x0, Bhv_Custom_0x1300012c,16),
		...
		OBJECT_WITH_ACTS(56,2544,-625,3937,0,0,0,0x10000, bhvSlidingPlatform2,8),
		OBJECT_WITH_ACTS(137,-7875,328,-4631,0,0,0,0x60000, bhvExclamationBox,217),
		OBJECT_WITH_ACTS(56,3228,-215,4611,0,0,0,0x10000, bhvSlidingPlatform2,8),
		OBJECT_WITH_ACTS(137,-7341,299,2475,0,0,0,0x70000, bhvExclamationBox,255),
		OBJECT_WITH_ACTS(56,4231,195,5204,0,0,0,0x10000, bhvSlidingPlatform2,8),
		OBJECT_WITH_ACTS(56,4551,400,5853,0,0,0,0x10000, bhvSlidingPlatform2,8),
		...
		OBJECT_WITH_ACTS(56,2948,-625,5143,0,0,0,0x10000, bhvSlidingPlatform2,8),
		OBJECT_WITH_ACTS(56,4478,-215,4622,0,0,0,0x10000, bhvSlidingPlatform2,8),
		...
		OBJECT_WITH_ACTS(54,-1323,-453,2147,0,0,0,0x0, Bhv_Custom_0x1300012c,15),
		OBJECT_WITH_ACTS(54,-1160,1368,-4542,0,0,0,0x0, Bhv_Custom_0x1300012c,16),
		OBJECT_WITH_ACTS(54,-737,-453,2147,0,0,0,0x0, Bhv_Custom_0x1300012c,15),
		OBJECT_WITH_ACTS(5,865,-754,3579,0,90,0,0x0, bhvKickableBoard,63),
		OBJECT_WITH_ACTS(6,4062,-1570,-1669,0,90,0,0x0, Bhv_Custom_0x13000684,15),
		OBJECT_WITH_ACTS(6,4055,-1570,-2369,0,90,0,0x20000, Bhv_Custom_0x13000684,15),
		OBJECT_WITH_ACTS(6,3861,-1570,-4327,0,90,0,0x0, Bhv_Custom_0x13000684,15),
