...
#define ddd_area_1_collision col_ddd_1_0xe033410

extern const GeoLayout Geo_ddd_1_0x22a1700[];
#define ddd_area_1 Geo_ddd_1_0x22a1700

extern const BehaviorScript bhvStarRoadMMMCannon[];
#define bhvTTCPitBlock bhvStarRoadMMMCannon

extern const BehaviorScript bhvStarRoadMMMTambourine[]; // 55 = 0x37
#define bhvTTC2DRotator bhvStarRoadMMMTambourine

extern const BehaviorScript bhvStarRoadBee[];
#define bhvInSunkenShip bhvStarRoadBee

extern const BehaviorScript bhvStarRoadMMMDrumstick[]; // 54 = 0x36
#define Bhv_Custom_0x13004854 bhvStarRoadMMMDrumstick
...
const LevelScript level_ddd_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(55, star_road_mmm_tambourine_geo),
	LOAD_MODEL_FROM_GEO(54, star_road_mmm_drumstick_geo),
	...
	AREA(1, ddd_area_1),
		...
		OBJECT_WITH_ACTS_FORCE_INACTIVE(212,4481,-1240,-862,0,0,0,0x0, bhv1Up,59),
		OBJECT_WITH_ACTS(0,1076,1312,4870,0,16,0,0x0, bhvTTCPitBlock,63),
		OBJECT_WITH_ACTS_FORCE_INACTIVE(116,4481,-538,-1537,0,0,0,0x0, bhvOneCoin,59),
		...
		OBJECT_WITH_ACTS_FORCE_ACTIVE(122,4481,451,-862,0,0,0,0x2000000, bhvStar,4),
		...
		OBJECT_WITH_ACTS_FORCE_INACTIVE(116,4481,-508,-210,0,90,0,0x0, bhvOneCoin,59),
		OBJECT_WITH_ACTS_FORCE_INACTIVE(55,4481,-1240,-862,0,0,0,0x0, bhvTTC2DRotator,59),
		...
		OBJECT_WITH_ACTS_FORCE_INACTIVE(87,4583,97,-904,0,0,0,0x0, bhvInSunkenShip,59),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(116,4479,48,-1590,0,0,0,0x0, bhvOneCoin,4),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(116,4482,48,-124,0,0,0,0x0, bhvOneCoin,4),
		...
		OBJECT_WITH_ACTS_FORCE_ACTIVE(55,4481,451,-862,0,0,0,0x19000000, bhvTTC2DRotator,4),
