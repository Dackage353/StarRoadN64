...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT_WITH_ACTS(35,5465,-614,-3681,0,315,0,0x8080000 + RANDO_DOOR_PARAM(1, Randomizer_STAR_REQ_GG), bhvDoor,31),
		OBJECT_WITH_ACTS(35,5478,-614,644,0,225,0,0x8080000 + RANDO_DOOR_PARAM(2, Randomizer_STAR_REQ_CH), bhvDoor,31),
		OBJECT_WITH_ACTS(100,-6488,546,5261,0,90,0,0x0, bhvMips,31),
		OBJECT_WITH_ACTS(0,6395,-607,-1435,0,90,0,0x14000000 + RANDO_DOOR_PARAM(0, Randomizer_STAR_REQ_B1), bhvStarDoor,31),
		OBJECT_WITH_ACTS(0,6395,-607,-1593,0,270,0,0x14000000 + RANDO_DOOR_PARAM(0, Randomizer_STAR_REQ_B1), bhvStarDoor,31),
		...
		OBJECT_WITH_ACTS(0,3254,-938,5862,0,0,0,0x0, bhvFishSpawner,31),
		OBJECT_WITH_ACTS(0,105,-937,3865,0,0,0,0x0, bhvFishSpawner,31),
		...
		OBJECT_WITH_ACTS(0,-6013,-521,1952,0,0,0,0x0, bhvStarRoadOWMusic,31),
