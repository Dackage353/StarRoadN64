...
#define lll_area_1_collision col_lll_1_0xe037668

extern const GeoLayout Geo_lll_1_0x21c1700[];
#define lll_area_1 Geo_lll_1_0x21c1700

extern const BehaviorScript bhvStarRoadKCSun[]; // 55 = 0x37 = MODEL_TTM_BLUE_SMILEY
#define bhvEndToad bhvStarRoadKCSun
...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT_WITH_ACTS(55,3570,3693,3889,0,90,0,0xb0000, bhvEndToad,1),
		OBJECT_WITH_ACTS(55,-115,1710,-931,0,0,0,0xc0000, bhvEndToad,62),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(0,3186,-1513,960,0,270,0,0xd0000, bhvLllRotatingBlockWithFireBars,60),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(0,3186,-1513,-1250,0,0,0,0xe0000, bhvLllRotatingBlockWithFireBars,60),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(194,5201,-608,880,0,0,0,0x0, bhvCirclingAmp,60),
		OBJECT_WITH_ACTS_FORCE_INACTIVE(217,2661,2055,3793,0,0,327,0x0, bhvPushableMetalBox,3),
		OBJECT_WITH_ACTS_FORCE_INACTIVE(217,2826,2310,3793,0,0,327,0x0, bhvPushableMetalBox,3),
		...
		OBJECT_WITH_ACTS_FORCE_ACTIVE(122,4338,4896,3941,0,0,0,0x0, bhvStar,1),
		OBJECT_WITH_ACTS_SPECIAL(104,-4826,-2091,-4532,0,184,0,0x1020000, bhvKoopaTheQuick,2, 3),
		...
		OBJECT_WITH_ACTS_SPECIAL(0,-2704,1382,3180,0,0,0,0x0, bhvKoopaRaceEndpoint,2, 3),
		...
		OBJECT_WITH_ACTS(56,5980,3255,-7884,0,0,0,0x0, bhvWfBreakableWallLeft,63),
		OBJECT_WITH_ACTS(56,3397,3141,-1280,0,0,0,0x0, bhvWfBreakableWallLeft,63),
		OBJECT_WITH_ACTS(56,5067,4007,3942,0,0,0,0x0, bhvWfBreakableWallLeft,63),
		OBJECT_WITH_ACTS(56,-4548,-2395,37,0,0,0,0x0, bhvWfBreakableWallLeft,63),
		OBJECT_WITH_ACTS(56,-5209,2826,5082,0,0,0,0x0, bhvWfBreakableWallLeft,63),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(217,3181,-1530,-217,0,0,0,0x0, bhvPushableMetalBox,4),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(122,3181,-511,2262,0,0,0,0x2000000, bhvStar,4),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(194,5904,-608,880,0,0,0,0x0, bhvCirclingAmp,60),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(102,5576,-1429,-1454,0,0,0,0x0, bhvDDDPole,60),
		OBJECT_WITH_ACTS(0,3396,3451,997,0,0,0,0x70000, bhvExclamationBox,63),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(86,-3101,1110,-2320,0,0,0,0x0, bhvTweester,16),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(86,-6724,1495,-5271,0,0,0,0x0, bhvTweester,16),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(86,-2255,1315,-7318,0,0,0,0x0, bhvTweester,16),
		...
		OBJECT_WITH_ACTS(100,-4554,1216,3708,0,121,0,0x0, bhvWaterLevelPillar,63),
		OBJECT_WITH_ACTS(100,-1881,-1997,-5774,0,269,0,0x0, bhvWaterLevelPillar,63),
