...
const LevelScript level_sl_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(34, sl_platform_geo),
	...
	AREA(1, sl_area_1),
		...
		OBJECT_WITH_ACTS_FORCE_ACTIVE(116,4301,3725,3787,0,-151,0,0xe0000, bhvMoneybagHiddenRando,62),
		OBJECT_WITH_ACTS(18,-3742,1204,-2823,0,0,0,0x0, bhvTree,63),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(0,4516,3725,3300,90,0,0,0x20000, bhvCoinFormation,62),
		...
		OBJECT_WITH_ACTS_FORCE_ACTIVE(100,4507,3725,3336,0,0,0,0x0, bhvSmallChillBully,62),
		...
		OBJECT_WITH_ACTS(MODEL_PURPLE_SWITCH,-3850,1200,-1512,0,245,0,0, bhvFloorSwitchHiddenObjects, 31),
		OBJECT_WITH_ACTS(34,-2700,1100,-882,0,0,0,0, bhvHiddenObject, 31),
