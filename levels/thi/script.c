...
#include "levels/thi/custom_c/custom.collision.inc.c"
#define thi_area_1_collision col_thi_1_0xe046888
extern const GeoLayout Geo_thi_1_0x19e1700[];
#define thi_area_1 Geo_thi_1_0x19e1700

extern const BehaviorScript bhvStarRoadFFFInvPyramid[]; // 56 = 0x38 = MODEL_BBH_TUMBLING_PLATFORM_PART
#define bhvLllTiltingInvertedPyramid bhvStarRoadFFFInvPyramid

extern const BehaviorScript bhvStarRoadFFFWallPlatform[]; // 54 = 0x36 = MODEL_BBH_TILTING_FLOOR_PLATFORM
#define Bhv_Custom_0x13001e68 bhvStarRoadFFFWallPlatform

extern const BehaviorScript bhvStarRoadFFFLava[]; // 53 = 0x35 = MODEL_BBH_STAIRCASE_STEP
#define bhvRockSolid bhvStarRoadFFFLava

extern const BehaviorScript bhvStarRoadFFFPillar[]; // 58 = 0x3A = MODEL_BBH_MESH_ELEVATOR
#define bhvBowserSubDoor bhvStarRoadFFFPillar

extern const BehaviorScript bhvStarRoadFFFAutoscroller[];
#define bhvMantaRay bhvStarRoadFFFAutoscroller

extern const BehaviorScript bhvStarRoadFFFSink[]; // 59 = 0x3B = MODEL_BBH_MERRY_GO_ROUND
#define Bhv_Custom_0x13000fc0 bhvStarRoadFFFSink

extern const GeoLayout bhv_star_road_fff_inv_pyramid[];
extern const GeoLayout bhv_star_road_fff_wall_platform[];
extern const GeoLayout bhv_star_road_fff_lava[];
extern const GeoLayout bhv_star_road_fff_pillar[];
extern const GeoLayout bhv_star_road_fff_sink[];
...
const LevelScript level_thi_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_BBH_TUMBLING_PLATFORM_PART, bhv_star_road_fff_inv_pyramid),
	LOAD_MODEL_FROM_GEO(MODEL_BBH_TILTING_FLOOR_PLATFORM, bhv_star_road_fff_wall_platform),
	LOAD_MODEL_FROM_GEO(MODEL_BBH_STAIRCASE_STEP, bhv_star_road_fff_lava),
	LOAD_MODEL_FROM_GEO(MODEL_BBH_MESH_ELEVATOR, bhv_star_road_fff_pillar),
	LOAD_MODEL_FROM_GEO(MODEL_BBH_MERRY_GO_ROUND, bhv_star_road_fff_sink),
	...
	AREA(1, thi_area_1),
		...
		OBJECT_WITH_ACTS_FORCE_ACTIVE(54,2467,-677,1813,0,180,0,0x0, Bhv_Custom_0x13001e68,24),
		...
		OBJECT_WITH_ACTS_FORCE_ACTIVE(54,2467,-417,2236,0,180,0,0x0, Bhv_Custom_0x13001e68,24),
		OBJECT_WITH_ACTS_FORCE_ACTIVE(54