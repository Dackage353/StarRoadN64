...
#define bob_area_1_collision col_bob_1_0xe037a40
...
extern const BehaviorScript bhvStarRoadBOIRock[];
extern const BehaviorScript bhvStarRoadBOIPlatform[];

extern const GeoLayout star_road_boi_rock_geo[];
extern const GeoLayout star_road_boi_platform_geo[];
...
const LevelScript level_bob_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_HMC_RED_GRILLS, star_road_boi_rock_geo),
	LOAD_MODEL_FROM_GEO(58,	star_road_boi_platform_geo),
	...
	AREA(1, bob_area_1),
		...
		OBJECT_WITH_ACTS(102,-5352,-2015,2524,0,180,0,0x0, bhvStarRoadChainChomp,63),
		...
		OBJECT_WITH_ACTS(0,2605,-2741,-3788,0,0,0,0x0, bhvFishSpawner,63),
		OBJECT_WITH_ACTS(0,2317,-2701,1949,0,0,0,0x0, bhvFishSpawner,63),
		...
		OBJECT_WITH_ACTS(0,3993,-2691,-1560,0,0,0,0x0, bhvFishSpawner,63),
		...
		OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-4781,-2004,2280,0,0,0,0x0, bhvStarRoadBOIRock,63),
		OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-3666,-2004,1825,0,0,0,0x0, bhvStarRoadBOIRock,63),
		OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-5901,-2004,2481,0,0,0,0x0, bhvStarRoadBOIRock,63),
		OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-5647,-2004,3624,0,0,0,0x0, bhvStarRoadBOIRock,63),
		OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-5509,-2004,942,0,0,0,0x0, bhvStarRoadBOIRock,63),
		...
		OBJECT_WITH_ACTS(58,1196,595,3189,0,0,0,0x0, bhvStarRoadBOIPlatform,63),
		OBJECT_WITH_ACTS(58,2756,937,3529,0,0,0,0x0, bhvStarRoadBOIPlatform,63),
