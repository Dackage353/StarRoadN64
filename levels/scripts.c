...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SPARKLES_ALT,            sparkles_alt_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_RED_COIN_RADAR,          red_coin_radar_geo), 
    LOAD_MODEL_FROM_GEO(MODEL_CHECKMARK,               checkmark_geo),
